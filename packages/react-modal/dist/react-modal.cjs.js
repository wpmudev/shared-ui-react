...
var reactDom_production_min = /*#__PURE__*/Object.freeze({
  __proto__: null
});

if(process.env.NODE_ENV!=="production"){(function(){var React=require('react');var _assign=require('object-assign');var Scheduler=require('scheduler');var tracing=require('scheduler/tracing');var ReactSharedInternals=React.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;// by calls to these methods by a Babel plugin.
//
...
var reactDom_development = /*#__PURE__*/Object.freeze({
  __proto__: null
});

var require$$0 = /*@__PURE__*/getAugmentedNamespace(reactDom_production_min);

var require$$1 = /*@__PURE__*/getAugmentedNamespace(reactDom_development);
...
class ReactFocusTrap extends React__default['default'].Component {
    constructor(props) {
        super(props);
    ...
    render() {
        const child = React__default['default'].Children.only(this.props.children);
        ...
        const childWithRef = React__default['default'].cloneElement(child, {
...
function displace(WrappedComponent, optionalOptions) {
    const options = optionalOptions || {};
    class Displaced extends React__default['default'].Component {
        componentDidMount() {
            this.container = (() => {
        ...
        render() {
            if (this.props.mounted === false)
                return null;
            if (this.container) {
                return reactDom.createPortal(React__default['default'].createElement(WrappedComponent, this.props, this.props.children), this.container);
            }
            return false;
        }
    }
...
class Modal extends React__default['default'].Component {
    ...
    render() {
        ...
        const childrenArray = [React__default['default'].createElement("div", Object.assign({}, dialogProps), props.children)];
        if (props.verticallyCenter) {
            childrenArray.unshift(React__default['default'].createElement("div", { key: "a", style: verticalCenterStyle }));
        }
        ...
        return (React__default['default'].createElement(ReactFocusTrap, { focusTrapOptions: focusTrapOptions, paused: props.focusTrapPaused },
            React__default['default'].createElement("div", Object.assign({}, underlayProps), childrenArray)));
    }
}
Modal.defaultProps = {
    underlayProps: {},
