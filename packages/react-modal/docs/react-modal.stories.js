...
const headerContent = ({ closeModal }) => {
	return (
		<BoxHeader alignment="right" paddingTop="20" paddingBottom="10" border="0">
			<ButtonIcon
...
const bodyContent = () => {
	return (
		<BoxBody alignment="center" paddingTop="0" paddingBottom="0">
	...
	return (
		<React.Fragment>
			<Box>
				...
				{bodyContent()}
				<BoxFooter alignment="center" border="0">
...
const renderOne = ({ closeModal, slideTo }) => {
	return (
		<React.Fragment>
			<Box>
				{headerContent({ closeModal })}
				<BoxBody alignment="center" paddingTop="0">
				...
				<BoxBody alignment="center" style={{ backgroundColor: "#f8f8f8" }}>
					<p>Here might go additional content.</p>
				</BoxBody>
				<BoxFooter alignment="right" border="0">
...
const renderTwo = ({ closeModal, slideTo }) => {
	return (
		<React.Fragment>
			<Box>
				<BoxHeader paddingTop="20" paddingBottom="10" border="0">
					<ButtonIcon
				...
				<BoxBody alignment="center">
					...
					<div className="sui-form-field" style={{ textAlign: "left" }}>
						<div className="sui-with-button sui-with-button-icon">
							...
							<ButtonIcon icon="arrow-right" label="Create" color="blue" />
						</div>
						<p className="sui-description">
	...
	const confirmationModalContent = ({ closeModal }) => {
		...
		return (
			<Box>
				...
				<BoxFooter alignment="center" paddingTop="0" border="0">
