import React, { Component, Children, Fragment, useState, useCallback, useEffect } from 'react';
...
var Modal = function Modal(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(AltModal, _extends$2({
...
var Pagination = function Pagination(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
  ...
  }, elements, " results"), /*#__PURE__*/React.createElement("ul", {
    className: "sui-pagination"
  }, skip && /*#__PURE__*/React.createElement("li", {
    ...
    "aria-hidden": "false",
    className: "sui-screen-reader-text"
  }, skipToFirstLabel || "Go to first page"), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    ...
    "aria-hidden": "false",
    className: "sui-screen-reader-text"
  }, previousLabel || "Go to previous page"), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    title: previousLabel || "Go to previous page",
    className: "sui-icon-chevron-left"
  }))), startIndex > 0 && /*#__PURE__*/React.createElement("li", {
    onClick: handlePreviousEllipsis
  }, /*#__PURE__*/React.createElement("a", null, "...")), pagesArray === null || pagesArray === void 0 ? void 0 : (_pagesArray$slice = pagesArray.slice(startIndex, endIndex)) === null || _pagesArray$slice === void 0 ? void 0 : _pagesArray$slice.map(function (data, index) {
  ...
  }), endIndex < pages && /*#__PURE__*/React.createElement("li", {
    ...
    "aria-hidden": "false",
    className: "sui-screen-reader-text"
  }, nextLabel || "Go to next page."), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    ...
    "aria-hidden": "false",
    className: "sui-screen-reader-text"
  }, skipToLastLabel || "Go to last page."), /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    title: skipToLastLabel || "Go to last page",
    className: "sui-icon-arrow-skip-forward"
  }))))), React.Children.map(childElements, function (child) {
    return /*#__PURE__*/React.cloneElement(child);
  }).slice(elementsStartIndex, elementsEndIndex));
};

export { Accordion, AccordionItem, AccordionItemBody, AccordionItemHeader, Box, BoxBody, BoxFooter, BoxHeader, BoxTitle, Button, ButtonIcon, Dropdown, Input, Modal, Notifications, Pagination, Post };
