...
for(var _key4 in props){if(/^(data-|aria-)/.test(_key4)){dialogProps[_key4]=props[_key4];}}var childrenArray=[/*#__PURE__*/React.createElement("div",Object.assign({},dialogProps),props.children)];if(props.verticallyCenter){childrenArray.unshift(/*#__PURE__*/React.createElement("div",{key:"a",style:verticalCenterStyle}));}var focusTrapOptions=props.focusTrapOptions||{};if(props.focusDialog||props.initialFocus){focusTrapOptions.initialFocus=props.focusDialog?"#".concat(this.props.dialogId):props.initialFocus;}focusTrapOptions.escapeDeactivates=props.escapeExits;return/*#__PURE__*/React.createElement(ReactFocusTrap,{focusTrapOptions:focusTrapOptions,paused:props.focusTrapPaused},/*#__PURE__*/React.createElement("div",Object.assign({},underlayProps),childrenArray));}}]);return Modal;}(React.Component);Modal.defaultProps={underlayProps:{},dialogId:"react-aria-modal-dialog",underlayClickExits:true,escapeExits:true,underlayColor:"rgba(0,0,0,0.5)",includeDefaultStyles:true,focusTrapPaused:false,scrollDisabled:true};var AriaModal=displace(Modal);AriaModal.renderTo=function(input){return displace(Modal,{renderTo:input});};var Modal$1=function Modal(_ref){var modalContent=_ref.modalContent,triggerContent=_ref.triggerContent,props=_objectWithoutProperties$3(_ref,["modalContent","triggerContent"]);var _React$useState=React.useState(false),_React$useState2=_slicedToArray(_React$useState,2),isOpen=_React$useState2[0],setIsOpen=_React$useState2[1];var _React$useState3=React.useState(false),_React$useState4=_slicedToArray(_React$useState3,2),isClosing=_React$useState4[0],setIsClosing=_React$useState4[1];// States for sliders.
var _React$useState5=React.useState(props.firstSlide),_React$useState6=_slicedToArray(_React$useState5,2),currentSlide=_React$useState6[0],setCurrentSlide=_React$useState6[1];var _React$useState7=React.useState(null),_React$useState8=_slicedToArray(_React$useState7,2),slideDirection=_React$useState8[0],setSlideDirection=_React$useState8[1];React.useEffect(function(){if(!props.dialogId){throw new Error('SUI Modal instances should have a `dialogId`');}},[]);var isSlider='object'===_typeof$1(modalContent)&&null!==modalContent;var openModal=function openModal(){return setIsOpen(true);},closeModal=function closeModal(){// Close the modal with the exit animation and reset the slider.
...
var Post = /*#__PURE__*/function (_Component) {
  ...
  _createClass$1(Post, [{
    ...
    value: function render() {
      ...
      if (this.props.image) {
        PostImage = /*#__PURE__*/React.createElement(FeaturedImage, _extends$3({
...
var Button$1 = styled.button(_templateObject2$2(), function (props) {
  return 'blue' === props.color ? 'color: #17A8E3 !important;' : '';
}, function (props) {
  return 'green' === props.color ? 'color: #1ABC9C !important;' : '';
}, function (props) {
...
var ItemImage = styled.span(_templateObject$3());
...
var AccordionItemHeader = /*#__PURE__*/function (_Component3) {
  ...
  _createClass$4(AccordionItemHeader, [{
    ...
    value: function render() {
      ...
      var indicator = /*#__PURE__*/React.createElement(ButtonIcon$3, {
        icon: "chevron-down",
...
export { Accordion, AccordionItem, AccordionItemBody, AccordionItemHeader, Box, BoxBody, BoxFooter, BoxHeader, BoxTitle, Button, ButtonIcon, Dropdown, Input, Modal$1 as Modal, Notifications, Post };
