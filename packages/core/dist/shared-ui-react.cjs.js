...
var Link = styled__default["default"].a(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral$3(["\n\t.sui-wrap && {\n\t\t", "\n\t\t", "\n\t\t", "\n\t\t", "\n\t\t", "\n\n\t\t[class*=\"sui-icon-\"]:before {\n\t\t\tcolor: inherit !important;\n\t\t}\n\n\t\t&:hover,\n\t\t&:focus {\n\t\t\t", "\n\t\t\t", "\n\t\t\t", "\n\t\t\t", "\n\t\t\t", "\n\t\t}\n\t}\n"])), function (props) {
...
var Button = styled__default["default"].button(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral$3(["\n\t.sui-wrap && {\n\t\t", "\n\t\t", "\n\t\t", "\n\t\t", "\n\t\t", "\n\n\t\t[class*=\"sui-icon-\"]:before {\n\t\t\tcolor: inherit !important;\n\t\t}\n\n\t\t&:hover,\n\t\t&:focus {\n\t\t\t", "\n\t\t\t", "\n\t\t\t", "\n\t\t\t", "\n\t\t\t", "\n\t\t}\n\n\t\t&[disabled] {\n\t\t\topacity: 0.5;\n\t\t\tpointer-events: none;\n\t\t}\n\t}\n"])), function (props) {
  return 'blue' === props.color ? 'color: #17A8E3 !important;' : '';
}, function (props) {
  return 'green' === props.color ? 'color: #1ABC9C !important;' : '';
}, function (props) {
...
var Pagination = function Pagination(_ref) {
  ...
  if (args !== null && args !== void 0 && args.paginationContent) return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, args === null || args === void 0 ? void 0 : args.paginationContent(_objectSpread2$3({}, properties)));else return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, pagesToBottom && PaginationResults(_objectSpread2$3({}, properties)), PaginationNav(_objectSpread2$3({}, properties)), !pagesToBottom && PaginationResults(_objectSpread2$3({}, properties)));
};
...
var PaginationResults = function PaginationResults(_ref3) {
  ...
  return React__default["default"].Children.map(properties.componentWrapper, function (data) {
    return /*#__PURE__*/React__default["default"].cloneElement(data, '', items);
  });
};
...
var PostHeader = styled__default["default"].div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral$2(["\n\tdisplay: flex;\n\tflex-flow: row wrap;\n\n\t+ div {\n\t\tmargin-top: 20px;\n\t}\n"])));
...
var PostTitle = styled__default["default"].h3(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral$2(["\n\toverflow: hidden;\n\tdisplay: -webkit-box !important;\n\t-webkit-box-orient: vertical;\n\t", "\n\tmargin: ", " !important;\n\tpadding: 0 !important;\n\tborder: 0;\n\tfont-size: 13px !important;\n\tline-height: 18px !important;\n\tfont-weight: 500 !important;\n\tletter-spacing: -0.2px;\n\t", "\n\n\t", "\n"])), function (props) {
...
var ReadMore = styled__default["default"].p(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral$2(["\n\tmin-width: 1px;\n\tflex: 1;\n\t", "\n\tcolor: #17A8E3 !important;\n\tfont-size: 13px !important;\n\tline-height: 18px !important;\n\tfont-weight: 500 !important;\n\tletter-spacing: -0.2px !important;\n"])), function (props) {
...
var ProgressBar = function ProgressBar(_ref) {
  ...
  var loaderMarkup = hasLoader && /*#__PURE__*/React__default["default"].createElement("span", {
    className: "sui-progress-icon"
  }, /*#__PURE__*/React__default["default"].createElement("span", {
    className: "sui-icon-loader sui-loading"
  }));
  var loaderText = hasLabel && /*#__PURE__*/React__default["default"].createElement("span", {
    className: "sui-progress-text"
  }, value, "%");
  var loaderBar = /*#__PURE__*/React__default["default"].createElement("div", {
  ...
  return /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, hasFrame && /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", {
    className: "sui-progress-block"
  }, innerMarkup), hasLegend && /*#__PURE__*/React__default["default"].createElement("div", {
...
var ItemImage = styled__default["default"].span(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n\twidth: 30px;\n\theight: 30px;\n\tmargin-right: 10px;\n\tborder-radius: 10px;\n\tbackground-repeat: no-repeat;\n\tbackground-size: cover;\n\tbackground-position: center;\n"])));
...
var Modal$1 = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var childrenArray = [/*#__PURE__*/React__default["default"].createElement('div', _objectSpread2({}, dialogProps), props.children)];
      ...
      }, /*#__PURE__*/React__default["default"].createElement('div', _objectSpread2({}, underlayProps), childrenArray));
    }
  }]);
