...
export default {
	title: 'Components/Progress bar/State',
...
export const primary = () => {
	return (
		<Template>
			<Section
				title="Progress Bar"
				code="&lt;ProgressBar cbFunction={() =&gt; {}} hasCancel={true} hasLabel={true} hasLoader={true} now={30} sourceLang={{ cancel: 'Pause', legend: 'Plugin is loading...' }} /&gt;"
				isDefault={ true }
				isLast={ true }>
				<ProgressBar
					cbFunction={() => {}}
