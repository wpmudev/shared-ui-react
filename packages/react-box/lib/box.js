...
export const Box = ({ children, className, ...props }) => {
	return (
		<div
			className={
				'undefined' !== typeof className && '' !== className ? `sui-box ${className}` : 'sui-box'
			}
			{...props}
		>
			{children}
...
export const BoxTitle = ({
	...
	return (
		<h3
			...
			{...props}
		>
			{icon && '' !== icon && <span className={`sui-icon-${icon} sui-md`} aria-hidden="true" />}
			{children}
			{tagLabel && '' !== tagLabel && (
				<span className={tagClass} style={{ marginLeft: 10 }}>
					{tagLabel}
				</span>
			)}
		</h3>
...
const Header = styled.div.attrs((props) => ({ props }))`
	.sui-wrap && {
		...
		${(props) =>
			'block' !== props.display &&
			('left' === props.alignment || 'right' === props.alignment || 'center' === props.alignment)
	...
	margin: 0;
		...
		border-bottom-width: ${(props) => (props.border || 0 === props.border ? props.border : 1)}px;
		${(props) =>
			'block' === props.display &&
			('right' === props.alignment || 'center' === props.alignment) &&
	...
	@media ${device.tablet} {
			padding-top: ${(props) =>
				props.paddingTop || 0 === props.paddingTop ? props.paddingTop : utils.gutter / 2}px;
			padding-right: ${(props) =>
				props.paddingRight || 0 === props.paddingRight ? props.paddingRight : utils.gutter}px;
			padding-bottom: ${(props) =>
				props.paddingBottom || 0 === props.paddingBottom
					? props.paddingBottom
					: utils.gutter / 2}px;
			padding-left: ${(props) =>
				props.paddingLeft || 0 === props.paddingLeft ? props.paddingLeft : utils.gutter}px;
		}
	}
`;
...
const Body = styled.div.attrs((props) => ({ props }))`
	.sui-wrap && {
		...
		border-top-width: ${(props) =>
			props.borderTop || 0 === props.borderTop ? props.borderTop : 0}px;
		border-bottom-width: ${(props) =>
			props.borderBottom || 0 === props.borderBottom ? props.borderBottom : 0}px;
		text-align: ${(props) => props.alignment || 'left'};

		@media ${device.tablet} {
			padding-top: ${(props) =>
				props.paddingTop || 0 === props.paddingTop ? props.paddingTop : utils.gutter}px;
			padding-right: ${(props) =>
				props.paddingRight || 0 === props.paddingRight ? props.paddingRight : utils.gutter}px;
			padding-bottom: ${(props) =>
				props.paddingBottom || 0 === props.paddingBottom ? props.paddingBottom : utils.gutter}px;
			padding-left: ${(props) =>
				props.paddingLeft || 0 === props.paddingLeft ? props.paddingLeft : utils.gutter}px;
		}
	}
...
const Footer = styled.div.attrs((props) => ({ props }))`
	...
	margin: 0;
		...
		border: 0 solid #e6e6e6;
		border-top-width: ${(props) =>
			props.border || 0 === props.border || '' === props.border ? props.border : 1}px;
		${(props) =>
			'block' === props.display &&
			('right' === props.alignment || 'center' === props.alignment) &&
			'text-align: ' + props.alignment + ';'}
