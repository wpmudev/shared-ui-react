...
var Box = styled.div(_templateObject$1(), device$1.tablet);
...
var ListWrapper = styled.ul(_templateObject3$1(), device$1.tablet);
var ListItem = styled.li(_templateObject4$1(), device$1.tablet, device$1.desktop);
var Navigation = styled.div(_templateObject5$1(), device$1.tablet, device$1.tablet, device$1.tablet);
  ...
  _createClass(TutorialsSlider, [{
    ...
    value: function render() {
      ...
      var listPosts = posts.map(function (post, i) {
        ...
        return /*#__PURE__*/React.createElement(ListItem, (_React$createElement = {
          key: post.id,
          className: "sui-tutorial"
        }, _defineProperty(_React$createElement, "className", 1 < i && !_this3.state.isShowingAll && 'sui-hidden'), _defineProperty(_React$createElement, "ref", 1 === i && _this3.secondTutorial), _React$createElement), /*#__PURE__*/React.createElement(Post, {
          role: "link",
          "data-href": post.link,
