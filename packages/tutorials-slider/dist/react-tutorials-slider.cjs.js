...
var Box = styled__default['default'].div(_templateObject$1(), device$1.tablet);
...
var ListWrapper = styled__default['default'].ul(_templateObject3$1(), device$1.tablet);
var ListItem = styled__default['default'].li(_templateObject4$1(), device$1.tablet, device$1.desktop);
var Navigation = styled__default['default'].div(_templateObject5$1(), device$1.tablet, device$1.tablet, device$1.tablet);
  ...
  _createClass(TutorialsSlider, [{
    ...
    value: function render() {
      ...
      var listPosts = posts.map(function (post, i) {
        ...
        }, _defineProperty(_React$createElement, "className", 1 < i && !_this3.state.isShowingAll && 'sui-hidden'), _defineProperty(_React$createElement, "ref", 1 === i && _this3.secondTutorial), _React$createElement), /*#__PURE__*/React__default['default'].createElement(Post, {
          role: "link",
          "data-href": post.link,
      ...
      if (error) {
        ...
        var navigation = /*#__PURE__*/React__default['default'].createElement(Navigation, null, (3 < posts.length && window.innerWidth < screen$1.desktop || 4 < posts.length) && [/*#__PURE__*/React__default['default'].createElement("button", {
          key: "1",
